...
import Screenshot_1 from '@/../../public/portifolio/Screenshot_1.jpg'
import Screenshot_2 from '@/../../public/portifolio/Screenshot_2.jpg'
import Screenshot_3 from '@/../../public/portifolio/Screenshot_3.jpg'
...
import Nest_icon from '@/../public/tecnologias/Nest_icon.png'
...
const PortifolioCard = ({item}:PortifolioCardProps) => {
    return (
        <article className="flex flex-col justify-between w-full h-full backdrop-blur-lg bg-gray-400/30 rounded-3xl overflow-hidden ">
            <div className=''>
                <Image width={700} height={700} alt={item.name} src={item.photo} className=' self-center' />
                ...
                <div className='gap-y-3 flex flex-col p-5 '>                
                    ...
                    <span className='flex gap-2 flex-wrap w-full justify-between px-2 '> 
                        <Image src={Git} alt={'Git'} width={25} height={25} />         
                        <Image src={HTML_icon} alt={'Git'} width={25} height={25} />
                        <Image src={CSS_icon} alt={'Git'} width={25} height={25} />
                        <Image src={Tailwind_icon} alt={'Git'} width={25} height={25} />
                        <Image src={JS_icon} alt={'Git'} width={25} height={25} />
                        <Image src={TS_icon} alt={'Git'} width={25} height={25} />
                        <Image src={React_icon} alt={'Git'} width={25} height={25} />
                        <Image src={Nest_icon} alt={'Git'} width={25} height={25} />
                    </span>  
                    <span className="flex gap-x-3">
                        <Link
                            ...
                            className=' w-max'>
                                <button
                                    className=' flex items-center gap-x-2 bg-blue-500 px-3 py-1 w-max rounded-md hover:bg-blue-600 transition text-white'>
                                    Ver Live
                        ...
                        <Link
                            ...
                            className=' w-max'>
                                <button
                                    className='flex flex-wrap items-center gap-x-2 bg-blue-500 px-3 py-1 w-max rounded-md hover:bg-blue-600 transition text-white'>
                                    Ver Código Fonte
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        width="16"
                                        height="16"
